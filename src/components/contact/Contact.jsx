        ...
        <div className="contact___options">
          <Slide bottom>
            <article className="contact___option">
              ...
              <h5>Email</h5>
              <h2>eng.mohamed.abozaid24</h2>
              <a href="mailto:eng.mohamed.abozaid24@gmail.com" target="blank">
                Send a message
              </a>
            </article>
          </Slide>
          <Slide bottom>
            <article className="contact___option">
              ...
              <h5>Messenger</h5>
              <h2>Mohamed Abozaid</h2>
              <a href="https://m.me/MoAl8" target="blank">
                Send a message
              </a>
            </article>
          </Slide>
          <Slide bottom>
            <article className="contact___option">
              ...
              <h5>Whatsapp</h5>
              <h2>00966570761235</h2>
              <a
                href="https://api.whatsapp.com/send?phone=00966570761235"
                target="blank"
              >
                Send a message
              </a>
